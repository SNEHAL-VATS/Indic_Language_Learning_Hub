...
class Chatbot:
    """Definition of a solitary chatbot endowed with memory, constructed using LangChain."""
    ...
    def __init__(self, engine):
        ...
        engine: the backbone llm-based chat model.
                ...
                Check this link : https://python.langchain.com/en/latest/modules/models/chat/integrations.html
        """
